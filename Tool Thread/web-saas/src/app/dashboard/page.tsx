      ...
      <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 md:p-10 text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">
            Chào mừng đến với Automation Hub 🤖
          </h1>
          ...
          <div className="flex gap-3">
            <Link href="/dashboard/accounts" className="bg-white text-blue-700 px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-blue-50 transition-colors shadow-sm">
              Thiết lập Bot
            </Link>
            <Link href="/dashboard/analytics" className="bg-blue-800/50 hover:bg-blue-800/80 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-colors border border-blue-500/30 backdrop-blur-sm">
              Xem Thống kê
            </Link>
          </div>
        </div>
