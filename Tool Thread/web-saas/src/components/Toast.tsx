...
export function Toast() {
  ...
  return (
    ...
    >
      <div className="bg-white/95 backdrop-blur-2xl text-gray-800 px-4 py-3 rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] flex items-center gap-3 border border-gray-100/80 min-w-[300px] max-w-sm relative overflow-hidden">
