...
// 2. Modify Threads Crawl Poster section
const oldPosterStr = `<div className="flex-1 overflow-y-auto pr-1 space-y-3.5 dim-siblings">
...
const newPosterStr = `<div className="relative flex-1 min-h-0">
                  {threadsPosts.length > 0 && (
                    <>
